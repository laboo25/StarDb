...
const Error404 = () => {
  ...
  return (
    <>
          <div className="error bg-amber-500 w-full h-screen bg-cover bg-center" style={{backgroundImage: 'url(https://raw.githubusercontent.com/laboo25/mag-imgs/main/imgs/LenaAnderson/mio―01.jpg)'}}>
